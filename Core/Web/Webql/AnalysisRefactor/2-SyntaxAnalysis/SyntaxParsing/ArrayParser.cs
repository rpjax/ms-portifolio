...
public class ArrayParser
{
    ...
    {
        return TokenParser.ParseProjectionLambda(context, ConsumeNextArrayToken(context));
    }
    ...
    {
        return TokenParser.ParseStatementBlock(context, ConsumeNextObjectToken(context));
    }
    ...
    public ArgumentSymbol[] ParseNextArgumentArray(ParsingContext context)
    {
        return TokenParser.ParseArgumentArray(context, ConsumeNextArrayToken(context));
    }
