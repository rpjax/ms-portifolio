...
public class ArrayParser
{
    ...
    public LambdaArgumentSymbol[] ParseNextLambdaArguments(ParsingContext context)
    {
        return SyntaxParser.ParseLambdaArguments(context, ConsumeNextArrayToken(context));
    }

    public LambdaArgumentSymbol[] ParseNextUnaryLambdaArguments(ParsingContext context)
    {
        return SyntaxParser.ParseUnaryLambdaArguments(context, ConsumeNextArrayToken(context));
    }
    ...
    {
        return SyntaxParser.ParseUnaryLambda(context, ConsumeNextArrayToken(context));
    }
