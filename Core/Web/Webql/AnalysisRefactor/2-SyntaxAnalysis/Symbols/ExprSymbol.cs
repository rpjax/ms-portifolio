...
public abstract class ExprSymbol : StatementSymbol
{
...
public class ProjectionExprSymbol : ExprSymbol
{
    public DestinationSymbol Destination { get; }
    public ArgumentSymbol Source { get; }
    public ProjectionLambdaSymbol Lambda { get; }

    public ProjectionExprSymbol(DestinationSymbol destination, ArgumentSymbol source, ProjectionLambdaSymbol lambda)
    {
        Destination = destination;
        Source = source;
        Lambda = lambda;
