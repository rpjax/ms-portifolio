...
public class AnonymousTypeExpressionSymbol : ExpressionSymbol, IEnumerable<ProjectionBindingSymbol>
{
    ...
    public AnonymousTypeExpressionSymbol(ProjectionBindingSymbol[] expressions)
    {
