...
public abstract class LinqProvider : ILinqProvider
{
    ...
    public MethodInfo GetWhereMethodInfo(TranslationContext context, QueryArgumentExpression source)
    {
    ...
    public MethodInfo GetSelectMethodInfo(TranslationContext context, QueryArgumentExpression source, Type resultType)
    {
        switch (source.GetLinqSourceType(context))
        {
            case LinqSourceType.Queryable:
    ...
    public MethodInfo GetSelectManyMethodInfo(TranslationContext context, QueryArgumentExpression source, Type resultType)
    {
        switch (source.GetLinqSourceType(context))
        {
            case LinqSourceType.Queryable:
    ...
    public MethodInfo GetTakeMethodInfo(TranslationContext context, QueryArgumentExpression source)
    {
        switch (source.GetLinqSourceType(context))
        {
            case LinqSourceType.Queryable:
    ...
    public MethodInfo GetSkipMethodInfo(TranslationContext context, QueryArgumentExpression source)
    {
        switch (source.GetLinqSourceType(context))
        {
            case LinqSourceType.Queryable:
    ...
    public MethodInfo GetAnyMethodInfo(TranslationContext context, QueryArgumentExpression source)
    {
        switch (source.GetLinqSourceType(context))
        {
            case LinqSourceType.Queryable:
    ...
    public MethodInfo GetAllMethodInfo(TranslationContext context, QueryArgumentExpression source)
    {
        switch (source.GetLinqSourceType(context))
        {
            case LinqSourceType.Queryable:
    ...
    public MethodInfo GetCountMethodInfo(TranslationContext context, QueryArgumentExpression source)
    {
        switch (source.GetLinqSourceType(context))
        {
            case LinqSourceType.Queryable:
    ...
    public MethodInfo GetMinMethodInfo(TranslationContext context, QueryArgumentExpression source, Type resultType)
    {
        switch (source.GetLinqSourceType(context))
        {
            case LinqSourceType.Queryable:
    ...
    public MethodInfo GetMaxMethodInfo(TranslationContext context, QueryArgumentExpression source, Type resultType)
    {
        switch (source.GetLinqSourceType(context))
        {
            case LinqSourceType.Queryable:
