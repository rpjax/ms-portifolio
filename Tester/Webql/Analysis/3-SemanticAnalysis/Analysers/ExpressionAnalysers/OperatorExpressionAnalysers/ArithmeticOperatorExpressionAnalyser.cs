...
public static class ArithmeticOperatorExpressionAnalyser
{
        ...
        OperatorExpressionSymbol symbol)
    {
        ...
        var leftSemantic = SemanticAnalyser.AnalyseExpression(context, arithmeticExpression.LeftOperand);
        var rightSemantic = SemanticAnalyser.AnalyseExpression(context, arithmeticExpression.RightOperand);
