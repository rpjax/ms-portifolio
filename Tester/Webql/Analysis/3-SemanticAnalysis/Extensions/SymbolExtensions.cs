...
public static class SymbolExtensions
{
    ...
    public static void AddDeclaration(this Symbol symbol, SemanticContext context, string identifier, Type? type)
    {
        context.AddSymbolDeclaration(identifier, symbol, type);
    }
