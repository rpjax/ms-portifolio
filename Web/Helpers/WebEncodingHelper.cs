...
/// </summary>
public static class WebEncodingHelper
{
    ...
    /// </remarks>
    public static string ToWebEncodedBase64(byte[] bytes)
    {
        return Convert
    ...
    /// <remarks>
    /// This method reverses the modifications made by <see cref="ToWebEncodedBase64(byte[])"/>, <br/>
    ...
    /// </remarks>
    public static byte[] FromWebEncodedBase64(string base64Text)
    {
