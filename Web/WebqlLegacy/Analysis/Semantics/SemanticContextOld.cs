...
public class SemanticContextOld
{
    ...
    public SemanticContextOld SetNavigationEnabled()
    {
    ...
    public SemanticContextOld SetNavigationDisabled()
    {
    ...
    public SemanticContextOld SetImplicitAndSyntaxEnabled()
    {
    ...
    public SemanticContextOld SetImplicitAndSyntaxDisabled()
    {
    ...
    public SemanticContextOld SetToProjectionSematics()
    {
    ...
    public SemanticContextOld CreateSemanticContext()
    {
        return new SemanticContextOld(this);
    }
