...
/// <summary>
/// Represents a serializable and web encodable version of the <see cref="UpdateExpression{T}"/> class.
...
public class SerializableUpdate
{
    ...
    /// <summary>
    /// Converts the serialized update into its corresponding <see cref="UpdateExpression{T}"/> object.
    /// </summary>
    /// <typeparam name="T">The type of the entity being updated.</typeparam>
    /// <returns>An <see cref="UpdateExpression{T}"/> object that represents the deserialized update.</returns>
    public UpdateExpression ToUpdate<T>() where T : class
    {
